...
namespace pluto
{
  ...
  static constexpr LegConfig LEG_CONFIGS[LEG_COUNT] = {
      ...
      // TODO: set the limits for each servo
      {
        ...
        {240, 355, 325, 320, 300, 15000, 60000, false},
        {150, 305, 275, 265, 275, -95000, -40000, false}
      },
      // TOP RIGHT
      {
        {250, 350, 295, 295, 295, -30000, 30000, false},
        {180, 270, 195, 215, 235, 15000, 60000, true},
        {270, 435, 305, 305, 305, -95000, -40000, true}
      },
      // BOTTOM LEFT
      {
        {185, 285, 230, 230, 230, -30000, 30000, true},
        {210, 370, 330, 285, 300, 15000, 60000, false},
        {195, 370, 360, 335, 360, -95000, -40000, false}
      }, 
      // BOTTOM RIGHT
      {
        {258, 358, 313, 313, 313, -30000, 30000, false},
        {200, 355, 250, 265, 265, 15000, 60000, true},
        {230, 425, 260, 255, 260, -95000, -40000, true}
      }
  };
} // namespace pluto
