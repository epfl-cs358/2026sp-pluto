...
namespace pluto
{
  ...
  static constexpr LegConfig LEG_CONFIGS[LEG_COUNT] = {
      ...
      // TODO: set the limits for each servo
      {
        ...
        {240, 355, 300,  15000, 60000, false},
        {150, 305, 275, -95000, -40000, false}
      },
      // TOP RIGHT
      {
        {250, 350, 295, -30000, 30000, false},
        {180, 270, 235,  15000, 60000, true},
        {270, 435, 305, -95000, -40000, true}
      },
      // BOTTOM LEFT
      {
        {185, 285, 230, -30000, 30000, true},
        {210, 370, 300,  15000, 60000, false},
        {195, 370, 320, -95000, -40000, false}
      }, 
      // BOTTOM RIGHT
      {
        {258, 358, 313, -30000, 30000, false},
        {200, 355, 265,  15000, 60000, true},
        {230, 425, 305, -95000, -40000, true}
      }
  };
} // namespace pluto
