...
namespace pluto
{
  ...
  static constexpr LegConfig LEG_CONFIGS[LEG_COUNT] = {
      ...
      // TODO: set the limits for each servo
      {
        ...
        {150, 305, 270, -95000, -40000, false}
      },
      // TOP RIGHT
      {
        {250, 350, 295, -30000, 30000, false},
        {180, 270, 245,  15000, 60000, true},
        {270, 435, 320, -95000, -40000, true}
      },
      // BOTTOM LEFT
      {
        {185, 285, 230, -30000, 30000, true},
        {210, 370, 325,  15000, 60000, false},
        {195, 370, 340, -95000, -40000, false}
      }, 
      // BOTTOM RIGHT
      {
        {258, 358, 313, -30000, 30000, false},
        {200, 355, 260,  15000, 60000, true},
        {230, 425, 255, -95000, -40000, true}
      }
  };
} // namespace pluto
