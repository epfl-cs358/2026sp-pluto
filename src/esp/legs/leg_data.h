...
namespace pluto
{
  ...
  static constexpr LegConfig LEG_CONFIGS[LEG_COUNT] = {
      ...
      // TODO: set the limits for each servo
      {
        ...
        {240, 355, 300, 300, 300, 15000, 60000, false},
        {150, 305, 275, 275, 275, -95000, -40000, false}
      },
      // TOP RIGHT
      {
        {250, 350, 295, 295, 295, -30000, 30000, false},
        {180, 270, 235, 235, 235, 15000, 60000, true},
        {270, 435, 305, 305, 305, -95000, -40000, true}
      },
      // BOTTOM LEFT
      {
        {185, 285, 230, 230, 230, -30000, 30000, true},
        {210, 370, 300, 300, 300, 15000, 60000, false},
        {195, 370, 360, 360, 360, -95000, -40000, false}
      }, 
      // BOTTOM RIGHT
      {
        {258, 358, 313, 313, 313, -30000, 30000, false},
        {200, 355, 265, 265, 265, 15000, 60000, true},
        {230, 425, 260, 260, 260, -95000, -40000, true}
      }
  };
} // namespace pluto
